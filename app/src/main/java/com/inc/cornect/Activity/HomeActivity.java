...
public class HomeActivity extends AppCompatActivity
    ...
    AppData data;
    TextView tv1, tv2;
    String email, full_name, picture, username;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1 = (TextView) navigationView.getHeaderView(0).findViewById(R.id.tv);
        tv2 = (TextView) navigationView.getHeaderView(0).findViewById(R.id.textView);
    ...
    private void SetUpValues() {
        if (choose.contentEquals("Personal")) {
            ...
            full_name = personal.last_name + " " + personal.first_name;
            picture = personal.picture;
            tv1.setText(full_name);
            tv2.setText(email);
            imageView.setImageBitmap(BitmapFactory.decodeFile(picture));
        } else {
            Corporate corporate = data.getCorporateInfo();
            username = corporate.organisation;
